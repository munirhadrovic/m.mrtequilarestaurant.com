	...
	<body>
		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Menu</a>
					</div>
				</div>

				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Mr Tequila 2</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Mr Tequila 2</a></li>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-gallery">
						<ul id="menu-gallery" class="menu-hide">
							...
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">BANQUETS</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">CATERING</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">TO GO</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">EVENTS</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">ORDER ONLINE</a></li>
							<li><a href="#contactform" data-transition="<?php echo $transitionefect ?>">CONTACT US</a></li>
						</ul>
					</section>		
						<div class="thumbs">
